...
### Introduction
- [Joint Bilateral Filter](https://hhoppe.com/flash.pdf), proposed by Petschnigg *et al.*, is based on the [bilateral filter](https://en.wikipedia.org/wiki/Bilateral_filter) and was originally used for flash/no-flash denoising. For more details, please refer to the paper:
