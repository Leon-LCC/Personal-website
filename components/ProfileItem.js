    ...
    if (type === 'education' || type === 'work' || type === 'research') {
        return (
            <Box alignItems="center" w='100%' position='relative' px='4' py='2' mb='2' borderRadius='lg' boxShadow='md' bg={useColorModeValue("#FFFFFF", "#323232")}>
                ...
                <HStack>
                    <Icon as={useColorModeValue(MdLocationOn, MdOutlineLocationOn)} width={{base:4, lg: 5}} height={{base:4, lg: 5}} color={useColorModeValue('#556B2F', '#A9A9A9')} pt={1} ml='0.5' mr='0.5'/>
                ...
                <HStack>
                    <Icon as={useColorModeValue(FaStickyNote, FaRegStickyNote)} width={{base:3, lg: 4}} height={{base:3, lg: 4}} color={'#DBA520'} pt={1} ml='1' mr='1'/>
        ...
        return (
            <Box alignItems="center" w='100%' position='relative' px='4' py='2' mb='2' borderRadius='lg' boxShadow='md' display={{base: 'none', md: 'grid' }} bg={useColorModeValue("#FFFFFF", "#323232")}>
                ...
                <HStack>
                    <Icon as={BsFillPersonFill} width={{base:4, lg: 5}} height={{base:4, lg: 5}} color={useColorModeValue('#4A4A4A', '#B9AAAA')} pt={1} ml='0.5' mr='0.5' pt={1} ml='0.5' mr='0.5'/>
